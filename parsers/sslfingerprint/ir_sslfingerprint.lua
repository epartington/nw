...
local parserName = "ir_sslfingerprint"
local ir_sslfingerprint = nw.createParser(parserName, "Implements JA3 SSL Fingerprinting")
...
function ir_sslfingerprint:init()
-- GREASE   https://tools.ietf.org/html/draft-davidben-tls-grease-00
self.GREASE =
{
      [2570] = true,
...
function ir_sslfingerprint:tlsHandshake(token, first, last)
...
ir_sslfingerprint:setCallbacks({
	--[nwevents.OnSessionBegin] = ir_sslfingerprint.SessionBegin,
	[nwevents.OnInit] = ir_sslfingerprint.init,
	["\022\003\000"] = ir_sslfingerprint.tlsHandshake,   -- SSL 3.0 0x160300
    ["\022\003\001"] = ir_sslfingerprint.tlsHandshake,   -- TLS 1.0 0x160301
    ["\022\003\002"] = ir_sslfingerprint.tlsHandshake,   -- TLS 1.1 0x160302
    ["\022\003\003"] = ir_sslfingerprint.tlsHandshake,   -- TLS 1.2 0x160303
})